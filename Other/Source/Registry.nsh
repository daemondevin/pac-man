...
!macro registry::BackupKey _PATH _ERR
	${IfNot} ${RegistryKeyExists} `${PAF}\Keys\${_PATH}`
	${AndIf} ${RegistryKeyExists} `${_PATH}`
		Registry::_MoveKey /NOUNLOAD `${_PATH}` `${PAF}\Keys\${_PATH}`
		Pop ${_ERR}
	${EndIf}
!macroend
...
!macro registry::BackupCopyKey _PATH _ERR
	${IfNot} ${RegistryKeyExists} `${PAF}\Keys\${_PATH}`
	${AndIf} ${RegistryKeyExists} `${_PATH}`
		Registry::_CopyKey /NOUNLOAD `${_PATH}` `${PAF}\Keys\${_PATH}`
		Pop ${_ERR}
	${EndIf}
!macroend
;===  0  # exists
...
!macro registry::RestoreBackupKey _PATH _ERR
	Registry::_DeleteKey /NOUNLOAD `${_PATH}`
	Pop ${_ERR}
	${If} ${RegistryKeyExists} `${PAF}\Keys\${_PATH}`
		Registry::_MoveKey /NOUNLOAD `${PAF}\Keys\${_PATH}` `${_PATH}`
		Pop ${_ERR}
		!insertmacro _LOGICLIB_TEMP
		StrCpy $_LOGICLIB_TEMP `${_PATH}`
		${Do}
			${GetParent} `$_LOGICLIB_TEMP` `$_LOGICLIB_TEMP`
			Registry::_DeleteKeyEmpty /NOUNLOAD `${PAF}\Keys\$_LOGICLIB_TEMP`
			Pop ${_ERR}
		${LoopUntil} `$_LOGICLIB_TEMP` == ""
	${EndIf}
	Registry::_DeleteKeyEmpty /NOUNLOAD ${PAF}\Keys
	Pop ${_ERR}
...
!macro registry::BackupValue _PATH _VALUE _ERR
	Registry::_MoveValue /NOUNLOAD `${_PATH}` `${_VALUE}` `${PAF}\Values` `${_VALUE}`
	Pop ${_ERR}
!macroend
!define registry::BackupCopyValue "!insertmacro registry::BackupCopyValue"
!macro registry::BackupCopyValue _PATH _VALUE _ERR
	Registry::_CopyValue /NOUNLOAD `${_PATH}` `${_VALUE}` `${PAF}\Values` `${_VALUE}`
	Pop ${_ERR}
!macroend
...
!macro registry::RestoreBackupValue _PATH _VALUE _ERR
	Registry::_DeleteValue /NOUNLOAD `${_PATH}` `${_VALUE}`
	Pop ${_ERR}
	Registry::_MoveValue /NOUNLOAD `${PAF}\Values` `${_VALUE}` `${_PATH}` `${_VALUE}`
	Pop ${_ERR}
	Registry::_DeleteKeyEmpty /NOUNLOAD ${PAF}\Values
	Pop ${_ERR}
	Registry::_DeleteKeyEmpty /NOUNLOAD ${PAF}
	Pop ${_ERR}
!macroend
