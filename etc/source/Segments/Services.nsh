...
; 
; USAGE
;	To make use of this segment, add the section [Service1] (numerical ordering) to the CompilerWrapper.ini file. 
...
; For more information on the macros found in this segment
...
!macro Service::Status _SVC _FSR _ERR1 _ERR2
	...
	StrCmpS ${_ERR1} 1 0 +4
	StrCmpS ${_ERR2} 1 0 +3
	${WriteRuntimeData} ${PAC} ${_SVC}_Status running
!macroend
; 
...
!macroend
; 
; The following macros were created by FukenGruven
; 
!ifdef SSDL
...
${SegmentPre}
	!ifdef SERVICES_ENABLED
		...
		${Do}
			ClearErrors
			ReadINIStr $0 "${WRAPPER}" "Service$R0" "Name"
		...
		${Do}
			...
			${If} $1 == replace
				...
				${IfNot} ${Errors}
					...
					${ReadWrapperConfig} $4 Service$R0 Type
					${ReadWrapperConfig} $5 Service$R0 Start
					${ReadWrapperConfig} $6 Service$R0 Depend
					${If} $6 != ""
